...
try {
	...
	echo "<div class=\"alert alert-success\" role=\"alert\">Email sent. I'll be in touch very soon.</div>";
} catch(Exception $exception) {
	echo "<div class=\"alert alert-danger\" role=\"alert\"><strong>oh wow!</strong> Unable to send email: " . $exception->getMessage() . "</div>";
}