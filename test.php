			...
			<section id="feature" class="p-y-4">
				<div class="container">
					<div class="row">
						...
						<div class="col-md-9">
							<p>Tuxedo cats always looking dapper hola te quiero yet fall over dead (not really but gets
								sypathy). White cat sleeps on a black shirt chase red laser dot, leave fur on owners clothes.
								Thinking longingly about tuna brine meow yet eat the fat cats food lay on arms while you're
								using the keyboard or roll on the floor purring your whiskers off jump around on couch, meow
								constantly until given food, . Paw at beetle and eat it before it gets away throwup on your
								pillow. Stick butt in face hopped up on catnip spread kitty litter all over house stare at wall
								turn and meow stare at wall some more meow again continue staring find something else more
								interesting</p>
						</div>
					</div>
				</div>
					...
					<div class="row">
						<div class="col-md-3">
							<div class="thumbnail">
								...
								<div class="caption">
									<h3>Title 1</h3>
									<p> Immediately regret falling into bathtub unwrap toilet paper yet spread kitty litter all
										over house, and touch water with paw then recoil in horror leave hair everywhere lick butt
										and make a weird face stretch</p>
								</div>
							</div><!--/.thumbnail-->
						</div><!--/.col-md-3-->
						<div class="col-md-3">
